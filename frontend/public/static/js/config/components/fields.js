...
export class ConfigType extends SelectFiled {
    constructor(types) {
        ...
        this._label.innerText = 'Modo de conexion'
    }
}
...
export class ConfigTlsVersion extends SelectFiled {
    constructor(versions) {
        ...
        this._label.innerHTML = 'Version do TLS'
    }
}
...
export class ConfigDesc extends TextFiled {
    constructor(desc) {
        ...
        this._label.innerHTML = 'información'
    }
...
export class ConfigSni extends TextFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Defina una SNI para la configuración')
        }
    }
}
...
export class ConfigPayload extends TextAreaFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Defina un PAYLOAD para configuración')
        }
    }
}
...
export class ConfigOpenVPN extends TextAreaFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Defina el certificado OpenVPN para configuración')
        }
    }
}
...
export class ConfigV2ray extends TextAreaFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Configuracion v2ray invalida!')
        }
    }
}
...
export class ConfigUdpPort extends TextFiled {
    constructor(port) {
        super()
        this._element.value = port
        this._label.innerHTML = 'Puerto UDP'
    }

    validate() {
        if (!this.getValue()) {
            throw new Error('Puerto UDP invalido!')
        }
    }
}
...
export class ConfigUrlCheckUser extends TextFiled {
    ...
    async _checkUrlOKClick() {
        try {
            ...
            if (isUrlOK) showToastSuccess('Su url esta OK!')
            else showToastError('URL offline o invalida!')
        } catch (e) {
